...
## inpu data
yan_met_1_0 <- readRDS("CFTR/results/Yan_dir_results/yan_MA_row_Lt_1_0.rds")
yan_met_1_1 <- readRDS("CFTR/results/Yan_dir_results/yan_MA_row_Lt_1_1.rds")
...
saveRDS(out_1_0, "CFTR/results/Yan_dir_results/out_1_0.rds")
out_1_1 <- check_sensitivity(X = yan_met_1_1, d_index = c(1:10), alpha = 1)
saveRDS(out_1_1, "CFTR/results/Yan_dir_results/out_1_1.rds")


## plot sensitivity
out_1_0 <- readRDS("CFTR/results/Yan_dir_results/out_1_0.rds")
plot_sencitivity(out_1_0)
out_1_1 <- readRDS("CFTR/results/Yan_dir_results/out_1_1.rds")
...
gKO = 'Cftr'
g_wei <- abs(WT[gKO, ])
gList_row <- colnames(WT)[which(g_wei == 0.1)]
...
## column trivial
g_wei <- abs(WT[, gKO])
gList_col <- colnames(WT)[which(g_wei == 0.1)]

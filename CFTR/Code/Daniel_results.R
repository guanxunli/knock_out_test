...
## inpu data
X_ori_row0 <- readRDS("CFTR/results/Daniel_results/Daniel_ori_row0.rds")
X_ori_col0 <- readRDS("CFTR/results/Daniel_results/Daniel_ori_col0.rds")
X_ori_both0 <- readRDS("CFTR/results/Daniel_results/Daniel_ori_both0.rds")
...
saveRDS(out_ori_row, file = "CFTR/results/Daniel_results/out_ori_row.rds")
out_ori_col <- check_sensitivity(X = X_ori_col0, d_index = c(1:10))
saveRDS(out_ori_col, file = "CFTR/results/Daniel_results/out_ori_col.rds")
out_ori_both <- check_sensitivity(X = X_ori_both0, d_index = c(1:10))
saveRDS(out_ori_both, file = "CFTR/results/Daniel_results/out_ori_both.rds")

## plot sensitivity
out_ori_row0 <- readRDS("CFTR/results/Daniel_results/out_ori_row.rds")
plot_sencitivity(out_ori_row0)
out_ori_col0 <- readRDS("CFTR/results/Daniel_results/out_ori_col.rds")
plot_sencitivity(out_ori_col0)
out_ori_both0 <- readRDS("CFTR/results/Daniel_results/out_ori_both.rds")

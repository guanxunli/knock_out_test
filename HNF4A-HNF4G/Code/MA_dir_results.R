...
## input data
MA_both_nnorm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/MA_both_nnorm_sym.rds")
MA_row_nnorm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/MA_row_nnorm_sym.rds")
MA_col_nnorm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/MA_col_nnorm_sym.rds")
MA_both_norm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/MA_both_norm_sym.rds")
MA_row_norm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/MA_row_norm_sym.rds")
MA_col_norm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/MA_col_norm_sym.rds")
...
saveRDS(out_row_nnorm_sym, "HNF4A-HNF4G/results/MA_dir_results//out_row_nnorm_sym.rds")
out_col_nnorm_sym <- check_sensitivity_fb(X = MA_col_nnorm_sym, d_index = c(1:10))
saveRDS(out_col_nnorm_sym, "HNF4A-HNF4G/results/MA_dir_results/out_col_nnorm_sym.rds")
out_both_nnorm_sym <- check_sensitivity_fb(X = MA_both_nnorm_sym, d_index = c(1:10))
saveRDS(out_both_nnorm_sym, "HNF4A-HNF4G/results/MA_dir_results/out_both_nnorm_sym.rds")

out_row_norm_sym <- check_sensitivity_fb(X = MA_row_norm_sym, d_index = c(1:10))
saveRDS(out_row_norm_sym, "HNF4A-HNF4G/results/MA_dir_results/out_row_norm_sym.rds")
out_col_norm_sym <- check_sensitivity_fb(X = MA_col_norm_sym, d_index = c(1:10))
saveRDS(out_col_norm_sym, "HNF4A-HNF4G/results/MA_dir_results/out_col_norm_sym.rds")
out_both_norm_sym <- check_sensitivity_fb(X = MA_both_norm_sym, d_index = c(1:10))
saveRDS(out_both_norm_sym, "HNF4A-HNF4G/results/MA_dir_results/out_both_norm_sym.rds")

## plot results
out_row_norm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/out_row_norm_sym.rds")
plot_sencitivity(out_row_norm_sym)
out_col_norm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/out_col_norm_sym.rds")
plot_sencitivity(out_col_norm_sym)
out_both_norm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/out_both_norm_sym.rds")
plot_sencitivity(out_both_norm_sym)
out_row_nnorm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/out_row_nnorm_sym.rds")
plot_sencitivity(out_row_nnorm_sym)
out_col_nnorm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/out_col_nnorm_sym.rds")
plot_sencitivity(out_col_nnorm_sym)
out_both_nnorm_sym <- readRDS("HNF4A-HNF4G/results/MA_dir_results/out_both_nnorm_sym.rds")

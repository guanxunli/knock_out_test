...
## inpu data
MA_row_sym <- readRDS("HNF4A-HNF4G/results/symmetry_results/MA_row_sym.rds")
MA_col_sym <- readRDS("HNF4A-HNF4G/results/symmetry_results/MA_col_sym.rds")
MA_both_sym <- readRDS("HNF4A-HNF4G/results/symmetry_results/MA_both_sym.rds")
...
saveRDS(out_row_sym, "HNF4A-HNF4G/results/symmetry_results/out_row_sym.rds")
out_col_sym <- check_sensitivity(X = MA_col_sym, d_index = c(1:10), alpha = 1)
saveRDS(out_col_sym, "HNF4A-HNF4G/results/symmetry_results/out_col_sym.rds")
out_both_sym <- check_sensitivity(X = MA_both_sym, d_index = c(1:10), alpha = 1)
saveRDS(out_both_sym, "HNF4A-HNF4G/results/symmetry_results/out_both_sym.rds")

## plot sensitivity
out_row_sym <- readRDS("HNF4A-HNF4G/results/symmetry_results/out_row_sym.rds")
plot_sencitivity(out_row_sym)
out_col_sym <- readRDS("HNF4A-HNF4G/results/symmetry_results/out_col_sym.rds")
plot_sencitivity(out_col_sym)
out_both_sym <- readRDS("HNF4A-HNF4G/results/symmetry_results/out_both_sym.rds")

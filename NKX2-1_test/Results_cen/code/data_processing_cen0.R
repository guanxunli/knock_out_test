...
KO <- WT
KO["Nkx2-1", ] <- 0
MA <- readRDS("NKX2-1_test/Results_cen/data/ma_cen0.rds")
...
## plot DR
png('NKX2-1_test/Results_cen/results/dr_cen0_GSM3716703.png', width = 2500, height = 2500, res = 300)
plotDR(GSM3716703, boldGenes = dGenes[dGenes %in% markerGenes])
dev.off()

## pathway
png('NKX2-1_test/Results_cen/results/ego_cen0_GSM3716703.png', width = 5000,height = 5000, res = 300, pointsize = 20, bg = NA)
X <- GSM3716703
gKO <- 'Nkx2-1'
q <- 0.995
...
png('NKX2-1_test/Results_cen/Results/gsea1_cen0_GSM3716703.png', width = 1000, height = 1000, res = 300)
...
## gsea2
png('NKX2-1_test/Results_cen/Results/gsea2__cen0_GSM3716703.png', width = 1000, height = 1000, res = 300)

...
GSM3716703 <- WT
WT <- readRDS("NKX2-1_test/Results_cen/data/WT.rds")
KO <- WT
KO["Nkx2-1", ] <- 0
MA <- readRDS("NKX2-1_test/Results_cen/data/ma_cen2.rds")
DR <- dRegulation(MA, "Nkx2-1")
GSM3716703$WT <- WT
GSM3716703$KO <- KO
GSM3716703$MA <- MA
GSM3716703$diffRegulation <- DR
...
## plot DR
png('NKX2-1_test/Results_cen/results/dr_cen2_GSM3716703.png', width = 2500, height = 2500, res = 300)
plotDR(GSM3716703, boldGenes = dGenes[dGenes %in% markerGenes])
dev.off()

## pathway
png('NKX2-1_test/Results_cen/results/ego_cen2_GSM3716703.png', width = 5000,height = 5000, res = 300, pointsize = 20, bg = NA)
X <- GSM3716703
gKO <- 'Nkx2-1'
q <- 0.995
gList <- unique(c(gKO, X$diffRegulation$gene[X$diffRegulation$p.value < 0.05]))
...
## gsea1
CT <- read.csv('NKX2-1_test/Data/PanglaoDB_markers_27_Mar_2020.tsv', header = TRUE, sep = '\t', stringsAsFactors = FALSE)
...
png('NKX2-1_test/Results_cen/Results/gsea1_cen2_GSM3716703.png', width = 1000, height = 1000, res = 300)
...
## gsea2
png('NKX2-1_test/Results_cen/Results/gsea2__cen2_GSM3716703.png', width = 1000, height = 1000, res = 300)
...
# png('NKX2-1_test/Results_cen/Results/gsea3_cen0_GSM3716703.png', width = 1000, height = 1000, res = 300)
...
# 
# png('NKX2-1_test/Results_cen/Results/gsea4_cen0_GSM3716703.png', width = 1000, height = 1000, res = 300)

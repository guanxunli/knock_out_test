...
set.seed(1)
MA <- manifoldAlignment(WT, KO, d = 3, lambda = 0.9, k = 2, gamma = 1, methoduse = 1)
set.seed(1)
...
saveRDS(outputList, "Ahr_yan_k2_gamma1_method1.rds")

set.seed(1)
MA <- manifoldAlignment(WT, KO, d = 3, lambda = 0.9, k = 2, gamma = 1, methoduse = 0)
set.seed(1)
DR <- dRegulation(MA, gKO = 'Ahr')
outputList <- list()
outputList$WT <- WT
...
saveRDS(outputList, "Ahr_yan_k2_gamma1_method0.rds")

set.seed(1)
MA <- manifoldAlignment(WT, KO, d = 3, lambda = 0.9, k = 2, gamma = 0.5, methoduse = 1)
set.seed(1)
DR <- dRegulation(MA, gKO = 'Ahr')
outputList <- list()
outputList$WT <- WT
...
saveRDS(outputList, "Ahr_yan_k2_gamma0_method1.rds")

set.seed(1)
MA <- manifoldAlignment(WT, KO, d = 3, lambda = 0.9, k = 2, gamma = 0.5, methoduse = 0)
set.seed(1)
DR <- dRegulation(MA, gKO = 'Ahr')
outputList <- list()
outputList$WT <- WT
...
saveRDS(outputList, "Ahr_yan_k2_gamma0_method0.rds")
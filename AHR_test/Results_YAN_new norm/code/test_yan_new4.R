...
saveRDS(outputList, "Ahr_yan_k4_gamma1_method1.rds")
...
saveRDS(outputList, "Ahr_yan_k4_gamma1_method0.rds")
...
saveRDS(outputList, "Ahr_yan_k4_gamma0_method1.rds")
...
saveRDS(outputList, "Ahr_yan_k4_gamma0_method0.rds")
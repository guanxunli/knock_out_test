...
set.seed(1)
MA <- manifoldAlignment(WT, KO, d = 5, lambda = 0.9, k = 2, gamma = 1, methoduse = 1)
set.seed(1)
...
set.seed(1)
MA <- manifoldAlignment(WT, KO, d = 5, lambda = 0.9, k = 2, gamma = 1, methoduse = 0)
set.seed(1)
DR <- dRegulation(MA, gKO = 'Ahr')
outputList <- list()
outputList$WT <- WT
...
set.seed(1)
MA <- manifoldAlignment(WT, KO, d = 5, lambda = 0.9, k = 2, gamma = 0.5, methoduse = 1)
set.seed(1)
DR <- dRegulation(MA, gKO = 'Ahr')
outputList <- list()
outputList$WT <- WT
...
set.seed(1)
MA <- manifoldAlignment(WT, KO, d = 5, lambda = 0.9, k = 2, gamma = 0.5, methoduse = 0)
set.seed(1)
DR <- dRegulation(MA, gKO = 'Ahr')
outputList <- list()
outputList$WT <- WT

...
png('AHR_test/Results_Daniel/VLN3.png', width = 1500, height = 1500, res=300)
...
library(UpSetR)
png('AHR_test/Results_Daniel/fgsea3.png', width = 600, height = 600, res = 300)
...
png('AHR_test/Results_Daniel/DE_drLabels.png', width = 2000, height = 2000, res = 300)
...
png('AHR_test/Results_Daniel/KO3.png', width = 3500, height = 3500, res = 300)
...
source('https://raw.githubusercontent.com/dosorio/utilities/master/singleCell/plotDR.R')
png('AHR_test/Results_Daniel/KNK_NET.png', width = 1500, height = 1500, res = 300)
...
png('AHR_test/Results_Daniel/cl2_Ahr.png', width = 1200, height = 1200, res = 300)
CLB
dev.off()
...
png('AHR_test/Results_Daniel/KNK_NET.png', height = 2000, width = 2000, res = 300)
...
library(ggplot2)
png('AHR_test/Results_Daniel/DE_gseaMarkers.png', width = 1000, height = 1000, res = 300)
...
png('AHR_test/Results_Daniel/DR_gseaMarkers.png', width = 1000, height = 1000, res = 300)

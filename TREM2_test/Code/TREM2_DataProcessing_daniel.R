...
GSE130626 <- readRDS("TREM2_test/Results_daniel/trem2_daniel.rds")
dGenes <- GSE130626$diffRegulation$gene[GSE130626$diffRegulation$p.adj < 0.05]

## figure 1
png('TREM2_test/Results_daniel/dr2_GSE130626.png', width = 2000, height = 2000, res = 300)
plotDR(GSE130626)
dev.off()

## figure 2
png('TREM2_test/Results_daniel/ego2_GSE130626.png', width = 3000, height = 3000, res = 300, bg = NA)
X <- GSE130626
gKO <- 'Trem2'
q <- 0.995
...
png('TREM2_test/Results_daniel/YCgsea1_GSE130626.png', width = 1000, height = 1000, res = 300)
...
## figure 4
png('TREM2_test/Results_daniel/YCgsea2_GSE130626.png', width = 1000, height = 1000, res = 300)
...
## figure 5
png('TREM2_test/Results_daniel/YCgsea3_GSE130626.png', width = 1000, height = 1000, res = 300)
gSet <- 'Lysosome'
plotEnrichment(MGI[[gSet]], zGSE130626) +
  labs(
    title = gSet,

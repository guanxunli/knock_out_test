...
KO <- WT
KO["Trem2", ] <- 0
MA <- readRDS("TREM2_test/Results_cen/data/ma_cen0.rds")
GSE130626$WT <- WT
GSE130626$KO <- KO
...
png('TREM2_test/Results_cen/results/dr_cen0_GSE130626.png', width = 2000, height = 2000, res = 300)
plotDR(GSE130626)
dev.off()

## plot pathway
png('TREM2_test/Results_cen/results/ego_cen0_GSE130626.png', width = 3000, height = 3000, res = 300, bg = NA)
X <- GSE130626
gKO <- 'Trem2'
q <- 0.995
...
png('TREM2_test/Results_cen/results/gsea1_cen0_GSE130626.png', width = 1000, height = 1000, res = 300)
...
## gsea2
png('TREM2_test/Results_cen/results/gsea2_cen0_GSE130626.png', width = 1000, height = 1000, res = 300)
...
## gsea3
png('TREM2_test/Results_cen/results/gsea3_cen0_GSE130626.png', width = 1000, height = 1000, res = 300)
gSet <- 'Lysosome'
plotEnrichment(MGI[[gSet]], zGSE130626) +
  labs(
    title = gSet,

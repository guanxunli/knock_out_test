...
## inpu data
X_ori_row0 <- readRDS("TREM2/results/Daniel_results/Daniel_ori_row0.rds")
X_ori_col0 <- readRDS("TREM2/results/Daniel_results/Daniel_ori_col0.rds")
X_ori_both0 <- readRDS("TREM2/results/Daniel_results/Daniel_ori_both0.rds")

...
## input data
MA_both_nnorm <- readRDS("TREM2/results/MA_dir_results/MA_both_nnorm.rds")
MA_row_nnorm <- readRDS("TREM2/results/MA_dir_results/MA_row_nnorm.rds")
MA_col_nnorm <- readRDS("TREM2/results/MA_dir_results/MA_col_nnorm.rds")
MA_both_norm <- readRDS("TREM2/results/MA_dir_results/MA_both_norm.rds")
MA_row_norm <- readRDS("TREM2/results/MA_dir_results/MA_row_norm.rds")
MA_col_norm <- readRDS("TREM2/results/MA_dir_results/MA_col_norm.rds")
...
saveRDS(out_row_norm, "TREM2/results/MA_dir_results/out_row_norm.rds")
out_col_norm <- check_sensitivity(X = MA_col_norm, d_index = c(1:10), alpha = 1)
saveRDS(out_col_norm, "TREM2/results/MA_dir_results/out_col_norm.rds")
out_both_norm <- check_sensitivity(X = MA_both_norm, d_index = c(1:10), alpha = 0)
saveRDS(out_both_norm, "TREM2/results/MA_dir_results/out_both_norm.rds")

## plot results
out_row_norm <- readRDS("TREM2/results/MA_dir_results/out_row_norm.rds")
plot_sencitivity(out_row_norm)
out_col_norm <- readRDS("TREM2/results/MA_dir_results/out_col_norm.rds")
plot_sencitivity(out_col_norm)
out_both_norm <- readRDS("TREM2/results/MA_dir_results/out_both_norm.rds")
plot_sencitivity(out_both_norm)
out_row_nnorm <- readRDS("TREM2/results/MA_dir_results/out_row_nnorm.rds")
plot_sencitivity(out_row_nnorm)
out_col_nnorm <- readRDS("TREM2/results/MA_dir_results/out_col_nnorm.rds")
plot_sencitivity(out_col_nnorm)
out_both_nnorm <- readRDS("TREM2/results/MA_dir_results/out_both_nnorm.rds")

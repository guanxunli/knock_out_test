...
yan_met_1_1 <- readRDS("TREM2/results/Yan_dir_results/yan_MA_row_Lt_1_1.rds")
...
saveRDS(out_1_1, "TREM2/results/Yan_dir_results/out_1_1.rds")


## plot sensitivity
out_1_0 <- readRDS("TREM2/results/Yan_dir_results/out_1_0.rds")
plot_sencitivity(out_1_0)
out_1_1 <- readRDS("TREM2/results/Yan_dir_results/out_1_1.rds")
...
out_1_1 <- check_fun(X = yan_met_1_1, d = 1, alpha = 1)
...
check_intersect(out_1_1$gene, out_row_sym$gene)

...
saveRDS(out_row_nnorm_sym, "NKX2-1/results/MA_dir_results/out_row_nnorm_sym.rds")
out_col_nnorm_sym <- check_sensitivity(X = MA_col_nnorm_sym, d_index = c(1:10), alpha = 1)
saveRDS(out_col_nnorm_sym, "NKX2-1/results/MA_dir_results/out_col_nnorm_sym.rds")
out_both_nnorm_sym <- check_sensitivity(X = MA_both_nnorm_sym, d_index = c(1:10), alpha = 0)
saveRDS(out_both_nnorm_sym, "NKX2-1/results/MA_dir_results/out_both_nnorm_sym.rds")

out_row_norm_sym <- check_sensitivity(X = MA_row_norm_sym, d_index = c(1:10), alpha = 2)
saveRDS(out_row_norm_sym, "NKX2-1/results/MA_dir_results/out_row_norm_sym.rds")
out_col_norm_sym <- check_sensitivity(X = MA_col_norm_sym, d_index = c(1:10), alpha = 1)
saveRDS(out_col_norm_sym, "NKX2-1/results/MA_dir_results/out_col_norm_sym.rds")
out_both_norm_sym <- check_sensitivity(X = MA_both_norm_sym, d_index = c(1:10), alpha = 0)
saveRDS(out_both_norm_sym, "NKX2-1/results/MA_dir_results/out_both_norm_sym.rds")
...
out_both_norm_b_sym <- check_fun(X = MA_both_norm_sym, d = 2, alpha = 2)
...
check_intersect(out_row_norm_sym$gene, out_col_norm_sym$gene)
check_intersect(out_row_norm_sym$gene, out_ori_row0$gene)
check_intersect(out_row_norm_sym$gene, out_ori_col0$gene)
check_intersect(out_row_norm_sym$gene, out_ori_both0$gene)

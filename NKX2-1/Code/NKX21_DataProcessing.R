...
dGenes <- GSM3716703$diffRegulation$gene[GSM3716703$diffRegulation$p.adj < 0.05] # 171

png('test_results/dr_GSM3716703.png', width = 2500, height = 2500, res = 300)
plotDR(GSM3716703, boldGenes = dGenes[dGenes %in% markerGenes])
dev.off()

png('test_results/ego_GSM3716703.png', width = 5000,height = 5000, res = 300, pointsize = 20, bg = NA)
X <- GSM3716703
gKO <- 'Nkx2-1'
q <- 0.995
...
png('test_results/gsea1_GSM3716703.png', width = 1000, height = 1000, res = 300)
...
png('test_results/gsea2_GSM3716703.png', width = 1000, height = 1000, res = 300)
...
png('test_results/gsea3_GSM3716703.png', width = 1000, height = 1000, res = 300)
...
png('test_results/gsea4_GSM3716703.png', width = 1000, height = 1000, res = 300)

...
## inpu data
MA_row_sym <- readRDS("NKX2-1/results/row_sum_results//MA_row_sym.rds")
MA_col_sym <- readRDS("NKX2-1/results/row_sum_results//MA_col_sym.rds")
MA_both_sym <- readRDS("NKX2-1/results/row_sum_results//MA_both_sym.rds")
...
saveRDS(out_ori_row0, "NKX2-1/results/row_sum_results//out_ori_row.rds")
out_ori_col0 <- check_sensitivity(X = MA_col_sym, d_index = c(1:10), alpha = 1)
saveRDS(out_ori_col0, "NKX2-1/results/row_sum_results/out_ori_col.rds")
out_ori_both0 <- check_sensitivity(X = MA_both_sym, d_index = c(1:10), alpha = 1)
saveRDS(out_ori_both0, "NKX2-1/results/row_sum_results/out_ori_both.rds")

## plot sensitivity
out_row_sym <- readRDS("NKX2-1/results/row_sum_results/out_ori_row.rds")
plot_sencitivity(out_row_sym)
out_col_sym <- readRDS("NKX2-1/results/row_sum_results/out_ori_col.rds")
